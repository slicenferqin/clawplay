...
const SOULS: SoulMeta[] = [
  {
    ...
    title: '猫娘 Nova',
    summary: '有角色感，但不会为了卖萌牺牲清晰度。适合陪伴、轻技术问答和创意写作。',
    category: 'creative',
    categoryLabel: '个性人格',
    sourceType: '原创',
    featured: true,
  ...
  },
  {
    ...
    title: '暴躁老王',
    summary: '毒舌但靠谱，适合日常开发、Debug、代码审查，输出有情绪但不失专业。',
    category: 'creative',
    categoryLabel: '个性人格',
    sourceType: '原创',
    tags: ['毒舌', '编程搭档', '调试'],
    tones: ['直给', '暴躁', '专业'],
    useCases: ['日常开发', 'Debug', '代码审查'],
    compatibleModels: ['Claude Sonnet', 'Claude Opus'],
    author: 'ClawPlay 社区',
    license: 'CC BY 4.0',
    updatedAt: '2026-03-06',
  ...
  },
  {
    ...
    title: '苏格拉底导师',
    summary: '不直接给答案，而是通过问题引导你自己想清楚。适合学习和思辨。',
    category: 'learning',
    categoryLabel: '学习伙伴',
    sourceType: '原创',
    tags: ['提问', '学习', '引导'],
  ...
  },
  {
    ...
    title: '敏捷项目经理',
    summary: '适合拆需求、排优先级、推迭代节奏，用项目视角帮你把事情落地。',
    category: 'work',
    categoryLabel: '工作助手',
    sourceType: '原创',
    tags: ['敏捷', '项目管理', '优先级'],
    tones: ['结构化', '务实', '推进'],
    useCases: ['拆需求', '排优先级', '迭代规划'],
    compatibleModels: ['Claude Sonnet', 'Claude Opus'],
    author: 'ClawPlay 社区',
    license: 'CC BY 4.0',
    updatedAt: '2026-03-06',
  ...
  },
  {
    ...
    title: '三省六部·御用谋士',
    summary: '适合复杂任务的规划、审议和执行。先想清楚，再动手，少一点氛围，多一点判断。',
    category: 'work',
    categoryLabel: '工作助手',
    sourceType: '原创',
    featured: true,
    ...
    license: 'CC BY 4.0',
    updatedAt: '2026-03-06',
    previewHook: '先规划，再审议，再执行，适合不想让 AI 一上来就瞎做的人。',
  ...
  },
  {
    ...
    compatibleModels: ['Claude Sonnet', 'Claude Opus'],
    author: 'thedaviddias / ClawPlay 社区',
    license: '待确认来源协议',
    updatedAt: '2026-03-06',
  ...
  },
  {
    ...
    title: '代码审查官',
    summary: '专门看 diff、抓回归、提风险和指出漏测，适合需要快速质量判断的开发场景。',
    category: 'translated',
    categoryLabel: '翻译精选',
    sourceType: '翻译',
    featured: true,
