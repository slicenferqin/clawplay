...
export const metadata: Metadata = buildPageMetadata({
  title: '关于 ClawPlay',
  description: '了解 ClawPlay 的项目定位、内容来源原则、投稿审核规则，以及联系与安全反馈方式。',
  pathname: '/about',
  ...
  return (
    <>
      ...
      <main className="page-shell prose-page about-page">
        ...
        <h1>这是一个中文 Soul 目录与分享站，不是临时堆文件的页面</h1>
        <p className="prose-page__lead">
          ClawPlay 想解决的不是“有没有 Soul”，而是“有 Soul，但找、比、装、分享都太散”。所以它把零散的 <code>SOUL.md</code> 整理成一个可浏览、可比较、可安装、可投稿的站点。
        </p>

        <section>
          <h2>ClawPlay 是什么</h2>
          <ul>
            <li>一个面向 OpenClaw 的中文 Soul 目录站。</li>
            <li>一个支持原文查看、下载、安装和投稿的分享入口。</li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>审核重点是内容是否可信、是否可安装、来源与授权是否清楚。</li>
        ...
        <div className="prose-page__actions">
          ...
          <Link href="/submit" className="text-action-link">投稿我的 Soul</Link>
        </div>
      </main>
    </>
  );
