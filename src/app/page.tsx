...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: '发现不同气质的 OpenClaw Soul preset。先看人格预览、原始 SOUL 与边界，再决定是否导入自己的龙虾。',
  pathname: '/',
  keywords: ['Soul 人格', '灵魂人格', 'Soul preset', 'OpenClaw', '导入 Soul'],
});
      ...
      <main className="page-shell home-page">
        ...
        <section className="content-section">
          ...
          <div className="journey-grid">
            <article className="journey-card">
              <span className="journey-card__eyebrow">01 先发现</span>
              <h3 className="journey-card__title">不用再靠群聊翻历史消息找灵魂人格</h3>
              <p className="journey-card__description">先看简介、标签、用途和来源，把零散的 Soul preset 放回一个能浏览、能比较的目录里。</p>
            ...
            <article className="journey-card">
              <span className="journey-card__eyebrow">02 再理解</span>
              <h3 className="journey-card__title">先看预览和原文，再判断它适不适合你的龙虾</h3>
              <p className="journey-card__description">不是先替换了再碰运气，而是先看气质、边界、语感和原始 SOUL 内容，再做选择。</p>
            ...
            <article className="journey-card">
              <span className="journey-card__eyebrow">03 再导入 / 分享</span>
              <h3 className="journey-card__title">喜欢就导入试试，调教好了也能继续分享</h3>
              <p className="journey-card__description">支持直接拉取原始 SOUL，也支持上传 `.md` 文件投稿，把值得留下的人格 preset 继续沉淀回站里。</p>
        ...
        <section className="install-strip">
          <div className="install-strip__content">
            <p className="install-strip__title">找到喜欢的灵魂后，先理解它，再复制导入命令。</p>
            <p>导入说明里已经把备份、替换、下载、回滚都写好；如果你也调教出了好用的 Soul，也可以直接上传 `.md` 文件分享。</p>
          </div>
          <div className="install-strip__actions">
            <Link href="/install">查看导入说明</Link>
            <Link href="/submit">分享我的 Soul</Link>
          </div>
        </section>
      </main>
    </>
